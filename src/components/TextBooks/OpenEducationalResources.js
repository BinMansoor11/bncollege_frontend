...
const FindTextBooks = () => {
  ...
  return (
    <div>
      <Header />
      <section className="mainContent mb-5 pb-5 " role="region">
        <div className="findCourseHeader mt-5 mb-3">
          <h1
            className="container font-weight-normal text-center font-size-10"
            id="skipNavigationToThisElement"
            tabIndex={0}
          >
            FIND OER MATERIALS
          </h1>
          <p className="text-center container col-6 text-muted font-size-2">
            Open Education Resources (OER) is a category of educational
            materials available in the public domain that is available with
            little or no-cost access, and with zero or limited restrictions in
            terms of usability repurposing and redistribution.
          </p>

          <p className="text-center container col-6 text-dark my-5 font-size-2">
            Note: Only those Departments, Courses, or Sections that have OER
            materials available will appear in the dropdowns for selection. If
            you do not see your course or section here, OER materials may not be
            available yet.
          </p>
        </div>
              ...
              <div className="campusContainer">
                <div className="columnTitles">
                  ...
                  {form.map((v, i) => {
                    return (
                      <ul className="columnLabelLayout nav container justify-content-center text-center my-3">
                        <li className="termColumn col-md-3 mx-2 d-block d-md-none font-weight-bold text-uppercase  font-size-1">
                          Term
                        </li>
                        <select
                  ...
                  <div className="container text-center justify-content-center d-flex mt-4">
                    <button
                      type="button"
                      class="btn btn-lg my-3  btn-block col-md-3 text-uppercase font-size-2"
                      style={styles.btn}
                    >
                      Find Materials
                    </button>
