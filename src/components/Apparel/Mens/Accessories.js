  ...
  return (
    <div>
      ...
      <div className="container col-9 headerText pt-2 mt-5">
        <h1 className="display-4 text-center">ACCESSORIES</h1>
        <hr />
      </div>
          ...
          <div class="row  my-5">
            <div className="col-4 container">
              <Link to="#">
                <img
                  ...
                  src="./assets/img/Mens_Accessories/SMALLIMAGE_1740290.jpg"
                />
            ...
            <div className="col-4 container">
              <Link to="#">
                <img
                  className="image img-fluid"
                  src="./assets/img/Mens_Accessories/SMALLIMAGE_1740292.jpg"
                />
                <div className="middle">
            ...
            <div className="col-4 container">
              <Link to="#">
                <img
                  className="image img-fluid"
                  src="./assets/img/Mens_Accessories/SMALLIMAGE_795882.jpg"
                />
                <div className="middle">
                  <div className="text">QUICKVIEW</div>
                </div>
