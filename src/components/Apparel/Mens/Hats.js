  ...
  return (
    <div>
      ...
      <div className="container col-9 headerText pt-2 mt-5">
        <h1 className="display-4 text-center">HATS</h1>
        <hr />
      </div>
          ...
          <div class="row  my-5">
            <div className="col-4 container">
              <Link to="#">
                <img
                  ...
                  src="./assets/img/Mens_Hats/SMALLIMAGE_1951747.jpg"
                />
            ...
            <div className="col-4 container">
              <Link to="#">
                <img
                  className="image img-fluid"
                  src="./assets/img/Mens_Hats/SMALLIMAGE_1851867.jpg"
                />
                <div className="middle">
                  <div className="text">QUICKVIEW</div>
                </div>
            ...
            <div className="col-4 container">
              <Link to="#">
                <img
                  className="image img-fluid"
                  src="./assets/img/Mens_Hats/SMALLIMAGE_464454.jpg"
                />
                <div className="middle">
