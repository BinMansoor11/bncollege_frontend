...
const YourRentals = ({ history, match }) => {
      ...
      <div className="row mt-5 py-3 mb-5 mr-auto">
        ...
        <div class="col-6 ">
          <div className="py-2">
            <div className="d-flex justify-content-between">
              <p className="font-size-2">
                It is recommended if you're returning multiple rental books, to
                place them in one box so that you only need one shipping label.
                Any fee associated to a printing label will occur for the
                initial label and any subsequent label. Access to this label is
                only available until the last day of the term.
              </p>
            </div>
          ...
          <div className="py-2 pb-2">
            <p>DIGITAL CONTENT RENTAL</p>
            <div className="edit-link">
              <p className="text-right font-size-2">
                <Link to="/textbooks/digitalcontentfaqs">
...
export default withRouter(YourRentals);
