...
const EmailAddresses = ({ history, match }) => {
          ...
          <div className="py-2 pb-5">
            ...
            >
              <p className="font-size-2 text-left ">
                alifaraz7866@gmail.com <br /> This is your log in ID. It can
                only be changed by going to{" "}
              ...
              <div className=" d-flex justify-content-center">
                ...
                >
                  <p className="">
                    ...
                    <span className="font-size-2 text-uppercase">
                      {" "}
                    ...
                    <div className="container pt-5">
                      <div className="row">
                        <div className="col-6">
                          ...
                          />
                          <div className="mt-2">
                            <div class="input-text d-flex align-items-center py-2">
                              <input
                                type="checkbox"
                                aria-label="Checkbox for following text input"
                              />
                              <span className="font-size-1 ml-1">
                                Messages about my orders
                              </span>
                            </div>
                            <div class="input-text d-flex align-items-center py-2">
                              <input
                              ...
                              />
                              <span className="font-size-1 ml-1">
                                Information about sales and promotions
                              </span>
                            </div>
                          </div>
                        </div>
...
export default withRouter(EmailAddresses);
